...
function Appointments() {
  ...
  return (
    <div className="appointments-page">
      ...
      {selectedBooking && <BookingDetails booking={selectedBooking} updating={updatingId === selectedBooking.id} onClose={() => setSelectedBooking(null)} onConfirm={() => changeStatus(selectedBooking, "Confirmed")} onCancel={() => setCancellingBooking(selectedBooking)} />}
